...
select add_retention_policy('metric-data', interval '1 month');
...
select add_retention_policy('transaction-sample-data', interval '1 month');
...
select add_retention_policy('analytic-event-data', interval '1 month');
...
select add_retention_policy('error-data', interval '1 month');
