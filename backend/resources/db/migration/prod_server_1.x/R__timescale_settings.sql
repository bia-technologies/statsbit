...
select add_drop_chunks_policy('metric-data', interval '6 months');
...
select add_drop_chunks_policy('transaction-sample-data', interval '1 months');
...
select add_drop_chunks_policy('analytic-event-data', interval '6 months');
...
select add_drop_chunks_policy('error-data', interval '6 months');
